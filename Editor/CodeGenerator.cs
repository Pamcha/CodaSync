...
namespace Com.Pamcha.CodaSync {
    public abstract class CodeGenerator {
        ...
        /// <summary>
        /// Banner prepended to every generated .cs file. First line is the Roslyn/StyleCop
        /// `<auto-generated>` marker so analyzers (and AI agents) treat the file as generated
        /// and skip it. The body explains that edits are overwritten on the next sync and what
        /// to do instead (edit the column in Coda, then re-import).
        /// </summary>
        private static string GeneratedHeader(string tableName) {
            return
@$"// <auto-generated>
//     Generated by Coda Sync for Unity — DO NOT EDIT.
//     Source: Coda table ""{tableName}"". Edits here are OVERWRITTEN on the next sync.
//     To change fields: add/remove/rename the column in the Coda doc, then re-import.
//     (Editing to fix a temporary compile error is OK, but it will not persist.)
// </auto-generated>
";
        }

        private static CodeFiles GetCodeFromTableStructure(TableStructure structure) {
            string header = GeneratedHeader(structure.UnmodifiedName);
